"""
Django settings for late_glade_dev_72496 project.
...
ROOT_URLCONF = 'late_glade_dev_72496.urls'
...
WSGI_APPLICATION = 'late_glade_dev_72496.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_glade_dev_72496 API",
    "DESCRIPTION": "API documentation for late_glade_dev_72496 App",
    "VERSION": "v1",
}
